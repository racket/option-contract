...
(require rackunit rackunit/text-ui racket/contract/option)
                                       ...
                                       (module server racket
                                         ...
                                         (provide (contract-out [boo
                                                                 (option/c
                                                                  ...
                                                                  #:with-contract #t)]))
                                         (define (boo x) 'wrong))
                                       (require racket/contract/option 'server)
                                       (boo 42))
                                      "server")
                                     ...
                                     (test-pass
                                      ...
                                      (script
                                       ...
                                       (module middle1 racket
                                         (require racket/contract/option 'middle0)
                                         (provide (contract-out [boo transfer/c])))
                                       (require racket/contract/option 'middle1)
                                       (boo 1)))
                                     ...
                                     (test-contract-fail
                                      ...
                                      (script
                                       ...
                                       (module client1 racket
                                         (require racket/contract/option 'client)
                                         (provide (contract-out [boo transfer/c]
                                                                [bar transfer/c])))
                                       (require 'client1)
                                       (bar boo))
                                     ...
                                     (test-contract-fail
                                      ...
                                      (script
                                       ...
                                       (module middle racket
                                         ...
                                         (provide (contract-out [boo transfer/c])))
                                       (module client racket
                                         (require racket/contract/option 'middle)
